            ...
            <div className={s.wrapper_bool}>
                <div className={s.root_click_}>
                    {loading ? (
                        ...
                        let indexElement = boxField.findIndex((el) => el.course_id === item._id);
                        return (
                            <div>
                                ...
                                {indexElement !== -1 ? (
                                    <div className={s.wrapper_date}>
                                        ...
                                        <MobileDateTimePicker
                                            ...
                                            onChange={(newValue) => {
                                                changeDate(item, newValue, indexElement, 'start_date')
                                            }}
                                            renderInput={(params) =>
                                                <TextField
                                                    {...params}
                                        ...
                                        <MobileDateTimePicker
                                            ...
                                            onChange={(newValue) => {
                                                changeDate(item, newValue, indexElement, 'end_date')
                                            }}
                                            renderInput={(params) =>
                                                <TextField
                                                    {...params}
