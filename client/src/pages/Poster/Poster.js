...
import {optionCreatePoster, optionCreateVideo, optionPoster} from "../../constants/OptionsTable";
...
export const Poster = () => {
    ...
    return (
        <div className={s.root}>
            ...
            <TableCard option={optionPoster} data={data} loading={loading} reload={getData} setData={filtersData} />
